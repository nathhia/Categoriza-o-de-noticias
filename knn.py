def bow_knn():
    ...
    training_data = util.get_parser_data("Re8.csv")
    X_train, X_test, y_train, y_test = train_test_split(training_data["texto"], training_data["noticia"], test_size=0.2, random_state=5)
